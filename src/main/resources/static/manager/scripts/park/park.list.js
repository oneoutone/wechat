(function() {
    angular
        ...
        .controller('ParkListCtrl', ParkListCtrl);

    ParkListCtrl.$inject = ['$scope', '$timeout', 'toastr', '$stateParams', '$state', 'httpService'];

    function ParkListCtrl ($scope, $timeout, toastr, $stateParams, $state, httpService) {
