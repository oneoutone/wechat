...
(function() {
    ...
    ManagerListCtrl.$inject = ['$scope', 'toastr'];

    function ManagerListCtrl($scope, toastr) {
        // function fetchManagers(){
        //     User.find({filter: {where: {teamId: $scope.app.user.teamId}, include: "roles", order: "created DESC"}}, function(users){
        ...
        //     User.deleteById({id: $scope.currentId}, function(result){
        //         $('#delete').modal('hide');
        //         fetchManagers()
        //     }, function(err){
        //         $('#delete').modal('hide');
